                    ...
                    <div class="sorteio-buscas">
                        <div class="row row-gutter-sm">
                            <div class="col">
                                <div class="mb-2">
                                    <div class="progress">
                                    <div class="progress-bar bg-info progress-bar-striped fw-bold progress-bar-animated" role="progressbar" aria-valuenow="1" aria-valuemin="0" aria-valuemax="100" style="width: 1%;"></div>
                    ...
                    <div class="app-vendas-express mb-2">
                        <div class="app-card card mb-2">
                            <div class="card-body text-center">
                                <p class="text-muted font-xs mb-3">Selecione a quantidade de números</p>
                                <div class="numeros-select d-flex align-items-center justify-content-center flex-column">
                                    ...
                                    <div class="item p-2 me-2 mb-2 flex-column d1">
                                        ...
                                        <p class="text-muted font-xss text-uppercase">Selecionar</p>
                                    </div>
                        ...
                        <button type="button" class="btn btn-wide btn-success participar" data-toggle="modal">SELECIONE UMA OPÇÃO PARA PARTICIPAR</button>
                    </div>
                </div>';
        }
        ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="numeros">
                        <h3>Seus números</h3>
                        <div class="num"></div>
                        <button class="btn btn-success efetuar-pagamento">EFETUAR PAGAMENTO</button>
                    </div>
                    <div class="qrcode">
                        <p id="contador"></p>
                        ...
                        <div class="pagamento">
                            ...
                            <div class="tooltip">
                                <button onclick="myFunction()" class="btn btn-dark">
                                    ...
                                    COPIAR CÓDIGO PIX <i class="fas fa-copy"></i>
                                </button>
                            </div>
                        </div>
